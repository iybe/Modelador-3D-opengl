...
//        break;
    ...
    case 'C':
        ...
        case 1:
            ...
            break;
        case 2:
            cam = new CameraDistante(6.58336,3.40453,-7.13283,0,1,0,-0.163084,0.970661,0.176696);
            break;
        case 3:
            cam = new CameraDistante(0,1,-5, 0,1,0, 0,1,0);
            break;
        case 4:
            cam = new CameraDistante(0,11,-0.000217469,0,1,0,0,-2.17469e-05,-1);
            break;
        case 5:
            cam = new CameraDistante(-6.66423,5.55421,5.90314,0,1,0,0.340909,0.890276,-0.301976);
            break;
        }
        break;
    case 's':
